        ...
        <div class="hero-content">
            <div class="text-rotator">
                <div class="text-set active">
                    <h1 class="glitch-text" data-text="FUTURE IS NOW">Coach Pro</h1>
                </div>
            </div>
        </div>
        <div class="cta-container">
            <a href="../pages/login.php" class="cta-button cta-primary">Get Started</a>
        </div>
    </section>
...
* {
        ...
        .particle::before {
            ...
            height: 2px;
            background: #00aE11;
            box-shadow: 0 0 10px #00aE11, 0 0 20px #00aE11;
        ...
        nav {
            ...
            border-bottom: 1px solid 00aE11;
        }
        ...
        .logo-text {
            ...
            font-size: 24px;
            font-weight: 900;
            background: linear-gradient(45deg, #00aE11, #00B2FF);
        ...
        .nav-links a::after {
            ...
            width: 0;
            height: 2px;
            background: linear-gradient(90deg, #00aE11, #00B2FF);
        ...
        .cta-secondary {
            ...
            color: #00aE11;
            border: 2px solid #00aE11;
            box-shadow: inset 0 0 20px 00aE11;
        }
        ...
        .content-panel h3 {
            ...
            font-size: 2rem;
            margin-bottom: 20px;
            background: linear-gradient(45deg, #ffffff, #00aE11);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
        }
        ...
        .map-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(45deg, transparent 40%, 00aE11 50%, transparent 60%);
